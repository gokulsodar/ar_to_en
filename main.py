...
def get_groq_response(text_to_translate: str, system_prompt: str):
    ...
    model = GroqModel('llama3-70b-8192', provider=GroqProvider(api_key=api_key))
...
@app.get("/")
async def root():
    return {"message": "Welcome to the Document Translation API. Go to /docs for the API documentation."}